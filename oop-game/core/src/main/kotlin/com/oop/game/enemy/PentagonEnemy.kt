...
// PentagonEnemy 역할 : HP 가 많고 속도는 PLAYER 보다 살짝 낮음. 비중 : 15%

class PentagonEnemy (
    x: Float,
    y: Float
) : SuperEnemy(x, y, 140f, 140f) {

    // 이미지 로딩
    private val texture = Texture(Gdx.files.internal("enemy_image/enemy_pentagon.png"))
    ...
    // 1. 채력 변수 - 종류마다 다르게 `
    override var enemyHp: Float = 500f
