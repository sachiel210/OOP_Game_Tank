...
import com.oop.game.example.enempyList.SuperEnemy
import com.oop.game.example.enempyList.DotEnemy
import com.oop.game.example.enempyList.TriangleEnemy
import com.oop.game.example.enempyList.SquardEnemy
import com.oop.game.example.enempyList.PentagonEnemy
...
class ExampleWorld(
    ...
    // 적 스폰 설정
    private val spawnInterval = 3f   // 3초마다 스폰
    ...
    /*
    // 적 — 월드 상단에서 좌우 왕복.
    private val enemy = ExampleEnemy(        //TODO : 적들 리스트로 만들어서 랜덤 소환
        x = 100f,
        y = worldHeight - 100f,
        minX = 0f,
        maxX = worldWidth
    ...
    */
    ...
    private fun spawnRandomEnemy() {
        ...
        val enemy = when {
            ...
            rand < spawnWeights[0] + spawnWeights[1]
                    + spawnWeights[2]                          -> SquardEnemy(spawnX, spawnY)
